<footer class="footer">
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-lg-3 mb-md-0 mb-4">
						<h2 class="footer-heading"><a href="#" class="logo">BookingAura</a></h2>
              ...
              <li><a href="#" class="py-1 d-block">Perfect central location</a></li>
					...
					<div class="col-md-6 col-lg-3 mb-md-0 mb-4">
						...
						<div class="tagcloud">
	            <a href="<?php echo APPURL;?>/#apartment-room" class="tag-cloud-link">apartment</a>
            ...
            <ul class="ftco-footer-social p-0">
              <li class="ftco-animate"><a href="https://x.com/rc_1663isme" data-toggle="tooltip" data-placement="top" title="Twitter"><span class="fa fa-twitter"></span></a></li>
              <li class="ftco-animate"><a href="https://www.facebook.com/Tromesdo" data-toggle="tooltip" data-placement="top" title="Facebook"><span class="fa fa-facebook"></span></a></li>
              <li class="ftco-animate"><a href="https://www.instagram.com/rc_1663/" data-toggle="tooltip" data-placement="top" title="Instagram"><span class="fa fa-instagram"></span></a></li>
			  <li class="ftco-animate"><a href="https://github.com/Romesdo" data-toggle="tooltip" data-placement="top" title="GitHub"><span class="fa fa-github"></span></a></li>
			...
			<div class="w-100 mt-5 border-top py-5">
	          ...
	          <div class="col-md-6 col-lg-8">
	            <p class="copyright mb-0">
	  				Copyright &copy;<script>document.write(new Date().getFullYear());</script> by Trần Đức Thiều: DH52111801
				</p>
	          </div>
