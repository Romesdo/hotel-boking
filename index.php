...
?>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-7 ftco-animate">
          	<h2 class="subheading">Welcome to BookingAura</h2>
    ...
    <section id="apartment-room" class="ftco-section bg-light">
			...
			<div class="row no-gutters">
					...
					<div class="col-lg-6">
						<div class="room-wrap d-md-flex">
							<a href="#" class="img" style="background-image: url(<?php echo ROOMSIMAGES; ?>/<?php echo $rooms->image; ?>);"></a>
			...
			<div class="container">
				<div class="row no-gutters">
					<div class="col-md-6 wrap-about">
						...
						<h2>The most recommended BookingAura</h2>
						<p>Discover a serene getaway where comfort meets elegance. Nestled in a picturesque setting, our vacation rental offers the perfect blend of modern amenities and natural beauty. Escape the ordinary and indulge in an unforgettable experience crafted just for you.</p>
					</div>
	          ...
	          <div class="pl-md-5">
							<p>Experience unparalleled comfort and luxury with tailored services to meet your every need. Your perfect escape awaits.</p>
							<div class="row">
		            <div class="services-2 col-lg-6 d-flex w-100">
		              ...
		              <div class="media-body pl-3">
		                ...
		                <p>Enjoy premium tea and coffee anytime, right in your room.</p>
		              </div>
		            </div> 
		            <div class="services-2 col-lg-6 d-flex w-100">
		              <div class="icon d-flex justify-content-center align-items-center">
		              ...
		              <div class="media-body pl-3">
		                ...
		                <p>Relax with invigorating high-pressure hot showers.</p>
		              </div>
		            </div>
		            <div class="services-2 col-lg-6 d-flex w-100">
		              <div class="icon d-flex justify-content-center align-items-center">
		              ...
		              <div class="media-body pl-3">
		                ...
		                <p>Fresh and clean clothes with our professional laundry service.</p>
		              </div>
		            </div>      
		            <div class="services-2 col-lg-6 d-flex w-100">
		              <div class="icon d-flex justify-content-center align-items-center">
		              ...
		              <div class="media-body pl-3">
		                ...
		                <p>Stay cool with advanced climate control systems.</p>
		              </div>
		            </div>
		            <div class="services-2 col-lg-6 d-flex w-100">
		              <div class="icon d-flex justify-content-center align-items-center">
		              ...
		              <div class="media-body pl-3">
		                ...
		                <p>Fast and free WiFi for all your browsing needs.</p>
		              </div>
		            </div> 
		            <div class="services-2 col-lg-6 d-flex w-100">
		              <div class="icon d-flex justify-content-center align-items-center">
		              ...
		              <div class="media-body pl-3">
		                ...
		                <p>Cook your favorites in a fully equipped kitchenette.</p>
		              </div>
		            </div> 
		            <div class="services-2 col-lg-6 d-flex w-100">
		              <div class="icon d-flex justify-content-center align-items-center">
		              ...
		              <div class="media-body pl-3">
		                ...
		                <p>Keep your outfits flawless with ironing facilities.</p>
		              </div>
		            </div> 
		            <div class="services-2 col-lg-6 d-flex w-100">
		              <div class="icon d-flex justify-content-center align-items-center">
		              ...
		              <div class="media-body pl-3">
		                ...
		                <p>Secure your valuables with our reliable lockers.</p>
		              </div>
		            </div>
		          </div>  
						</div>
